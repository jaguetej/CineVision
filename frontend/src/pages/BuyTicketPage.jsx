                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                    <div class="accordion-body">
                                        <section>
                                                <div className='row '>
                                                    <div className='col-sm-6 text-start'>
                                                        <p>Después de seleccionar la película y la función debes elegir el tipo de boleto.
                                                            Si eres estudiante, no olvides traer tu carnet.</p>                        
                                                    </div>
                                                </div>
                                        ...
                                        <div className='col-sm-6 mb-2 text-end'>
                                            {ticketItem === "placeSection" ?
                                                <button className='btn btn-dark' data-bs-toggle="collapse" 
                                                    ...
                                                    onClick={() => {
                                                        if (chairNumber !== 0) {
                                                            toast.warning("¡Por favor selecciona la misma cantidad de asientos que de boletos!", {
                                                                theme: "dark",
                                                                position: "top-center"
                                                            })
                                                        } else {
                                    ...
                                    <Form className='row justify-content-center align-items-start'>
                                        ...
                                        <div className='col-sm-12 col-md-6 mb-3'>
                                            ...
                                            <div className='row'>
                                                ...
                                                <p className='text-start'> <input class="form-check-input me-3" type="checkbox" value="" aria-label="Checkbox for following text input" required/>He leído y acepto los Términos de Información Previa
                                                y el Contrato de Venta a Distancia.
                                            </p>
                                            </div>
                                        </div>
